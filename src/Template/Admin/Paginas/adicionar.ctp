...
<h4><i class="fa fa-clone"></i> Adicionar Página</h4>
    ...
    <div class="col s2" style="margin-top:35px;">
        ...
        <div class="row">
            ...
            <div class="col s12 white z-depth-1" style="margin-top:25px;">
                ...
                <a class="btn green darken-4 col s10 gerenciadordemidia" data-fancybox-type="iframe" href="<?= $configuracoes['site_url'] ?>filemanager/dialog.php?type=1&field_id=thumbnail&relative_url=1&sort_by=date&fldr=paginas&akey=1ca6984gas62495k2asifcyqpf34863c"><i class="fa fa-file-o"></i> Escolher Arquivo</a>
