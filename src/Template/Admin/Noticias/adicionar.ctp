...
<h4><i class="fa fa-clone"></i> Adicionar Notícia</h4>

<div class="row">

    <div class="col l8 m8 s12" style="margin-right:15px;margin-top:5px;" data-aos="fade-up" data-aos-duration="1300">
        ...
        <div class="row">
            ...
            <div class="col s12 white z-depth-1">
                ...
                <div class="row">
                    ...
                    <?php $horario = date('d/m/Y H:i'); ?>

                    <div class="col s12">
                        <p><i class="fa fa-calendar"></i> Programar Postagem:</p>
                    </div>

                    <div class="col s11">
                        <input type="text" name="date" value="<?= $horario ?>" id="date" data-field="datetime" readonly>
                        <div id="dtBox"></div>
                    </div>

                </div>

                <?= $this->Form->button('Publicar', [
            ...
            <div class="col s12 white z-depth-1" style="margin-top:25px;">
                ...
                <div class="previa">
                    <img src="" class="previa-imagem responsive-img" alt="">
                </div>
                ...
                <a class="btn col s10 green darken-4 gerenciadordemidia" data-fancybox-type="iframe" href="<?= $configuracoes['site_url'] ?>filemanager/dialog.php?type=1&field_id=thumbnail&relative_url=1&sort_by=name&fldr=noticias/<?= date('Y'); ?>/<?= date('m'); ?>&akey=1ca6984gas62495k2asifcyqpf34863c"> Escolher Arquivo</a>
