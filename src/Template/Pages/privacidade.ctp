<?php $this->assign('title', 'Poíticas de privacidade'); ?>

<div class="container">

	<div class="pagina">

		<h1>Poíticas de privacidade</h1>
		<h2>Saiba como usamos seus dados.</h2>

		<h2>Todas as suas informações pessoais recolhidas, serão usadas para o ajudar a tornar a sua visita no nosso site o mais produtiva e agradável possível. A garantia da confidencialidade dos dados pessoais dos utilizadores do nosso site é importante para o SBA - Sistema Brasileiro do Agronegócio.</h2>

		<p>Todas as informações pessoais relativas a membros, assinantes, clientes ou visitantes que usem o SBA - Sistema Brasileiro do Agronegócio serão tratadas em concordância com a Lei da Proteção de Dados Pessoais de 26 de outubro de 1998 (Lei n.º 67/98).</p>
